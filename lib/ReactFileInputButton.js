...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactFileInputButton = function (_React$Component) {
		_inherits(ReactFileInputButton, _React$Component);
	
		function ReactFileInputButton() {
			var _ref;
	
			var _temp, _this, _ret;
	
			_classCallCheck(this, ReactFileInputButton);
	
			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}
	
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactFileInputButton.__proto__ || Object.getPrototypeOf(ReactFileInputButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (e) {
				_this.fileInput.click();
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}
	
		_createClass(ReactFileInputButton, [{
			key: 'render',
			value: function render() {
				...
				var inputProps = _objectWithoutProperties(_props, ['children']);
	
				return _react2.default.createElement(
					'span',
					{ onClick: this.handleClick },
					_react2.default.createElement('input', _extends({ ref: function ref(node) {
							_this2.fileInput = node;
						}, type: 'file' }, inputProps, { style: fileInputStyle })),
					children
				);
			}
		}]);
	
		return ReactFileInputButton;
	...
	exports.default = ReactFileInputButton;
...
/***/ }
/******/ ]);
//# sourceMappingURL=ReactFileInputButton.js.map